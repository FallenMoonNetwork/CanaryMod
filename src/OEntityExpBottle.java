public class OEntityExpBottle extends OEntityThrowable {
    ...
    public OEntityExpBottle(OWorld oworld, OEntityLivingBase oentitylivingbase) {
    ...
    protected void a(OMovingObjectPosition omovingobjectposition) {
        if (!(Boolean) etc.getLoader().callHook(PluginLoader.Hook.PROJECTILE_HIT, this.getEntity(), omovingobjectposition == null || omovingobjectposition.g == null ? null : omovingobjectposition.g.getEntity()) && !this.q.I) {
