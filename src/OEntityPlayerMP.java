...
public class OEntityPlayerMP extends OEntityPlayer implements OICrafting {
    ...
    public void F_() {
        ...
        for (int var1 = 0; var1 < 5; ++var1) {
            ...
            if (var2 != this.ck[var1]) {
                this.bi.getEntityTracker().sendPacketToPlayersAndEntity(this, new OPacket5PlayerInventory(this.bd, var1, var2));
                this.ck[var1] = var2;
            }
        }
    ...
    public void a(OEntity var1, int var2) {
        if (!var1.bE) {
            OEntityTracker var3 = this.bi.getEntityTracker().getTracker();
    ...
    public void C_() {
        if (!this.t) {
            this.u = -1;
            this.t = true;
            OEntityTracker var1 = this.bi.getEntityTracker().getTracker();
    ...
    public OEnumStatus a(int var1, int var2, int var3) {
        ...
        if (var4 == OEnumStatus.a) {
            OEntityTracker var5 = this.bi.getEntityTracker().getTracker();
    ...
    public void a(boolean var1, boolean var2, boolean var3) {
        if (this.Z()) {
            OEntityTracker var4 = this.bi.getEntityTracker().getTracker();
    ...
    public void c(OEntity var1) {
        OEntityTracker var2 = this.bi.getEntityTracker().getTracker();
