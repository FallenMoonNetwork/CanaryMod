...
public class OEntityLightningBolt extends OEntityWeatherEffect {
    ...
    public OEntityLightningBolt(OWorld oworld, double d0, double d1, double d2) {
        ...
        if (!oworld.I && oworld.O().b("doFireTick") && oworld.r >= 2 && oworld.b(OMathHelper.c(d0), OMathHelper.c(d1), OMathHelper.c(d2), 10)) {
            int i = OMathHelper.c(d0);
            int j = OMathHelper.c(d1);
            int k = OMathHelper.c(d2);

            if (oworld.a(i, j, k) == 0 && OBlock.aw.c(oworld, i, j, k)) {
                // CanaryMod: Ignite hook
                Block block = this.getEntity().getWorld().getBlockAt(i, j, k);
            ...
            for (i = 0; i < 4; ++i) {
                ...
                if (oworld.a(j, k, l) == 0 && OBlock.aw.c(oworld, j, k, l)) {
                    // CanaryMod: Ignite hook
                    Block block = this.getEntity().getWorld().getBlockAt(j, k, l);

                    block.setStatus(5); // lightning
                    if (!(Boolean) manager.callHook(PluginLoader.Hook.IGNITE, block, null)) {
                        oworld.c(j, k, l, OBlock.aw.cF);
                    }
                }
            }
        }
    ...
    public void l_() {
        ...
        if (this.b < 0) {
            if (this.c == 0) {
                ...
                this.b = 1;
                this.a = this.ab.nextLong();
                if (!this.q.I && this.q.O().b("doFireTick") && this.q.b(OMathHelper.c(this.u), OMathHelper.c(this.v), OMathHelper.c(this.w), 10)) {
                    int i = OMathHelper.c(this.u);
                    int j = OMathHelper.c(this.v);
                    int k = OMathHelper.c(this.w);
                    if (this.q.a(i, j, k) == 0 && OBlock.aw.c(this.q, i, j, k)) {
                        // CanaryMod: Ignite hook
                        Block block = this.getEntity().getWorld().getBlockAt(i, j, k);
