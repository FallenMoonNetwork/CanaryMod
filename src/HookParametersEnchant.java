...
/**
 * HookParametersEnchant - Passed to the ENCHANT hook. Contains the enchanting
 * player, enchanted item and a list of enchantments to apply on it. Changing
 * the list will change the enchantments applied.
 *
 * @author YLivay
 */
public class HookParametersEnchant extends HookParameters {
    ...
    public HookParametersEnchant(Player player, int itemId, List enchantments) {
        ...
        for (Object enchantObject : enchantments) {
            if (enchantObject instanceof OEnchantmentData) {
                // SRG this.enchantments.add(new Enchantment(Enchantment.Type.fromId(((OEnchantmentData) enchantObject).field_76302_b.field_77352_x), ((OEnchantmentData) enchantObject).field_76303_c));
                this.enchantments.add(new Enchantment(Enchantment.Type.fromId(((OEnchantmentData) enchantObject).b.z), ((OEnchantmentData) enchantObject).c));
            }
        }
    ...
    /**
     * Gets a list of enchantments to apply on the item. Changing this list will
     * change the enchantments that will be applied.
     *
     * @return
     */
